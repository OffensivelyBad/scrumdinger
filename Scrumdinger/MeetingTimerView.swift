...
struct MeetingTimerView_Previews: PreviewProvider {
    @State static var speakers = [ScrumTimer.Speaker(name: "Shane", isCompleted: true), ScrumTimer.Speaker(name: "Landsea", isCompleted: true), ScrumTimer.Speaker(name: "Landsea", isCompleted: false)]
